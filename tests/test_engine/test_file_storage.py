...
class TestFileStorage(unittest.TestCase):
	...
	"""
        all.objects = self.storage.all()
        self.assertIsNotNone(all.objects)
        self.assertEqual(type(all.objects), dict)
        self.assertIs(all.objects, self.storage._FileStorage__objects)
